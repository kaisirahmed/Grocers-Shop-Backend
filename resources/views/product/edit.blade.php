...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
            {!! Form::open([ 'method'=>'PATCH', 'route' => ['product.update',$product], 'files' => true , 'class' => 'custom-validation']) !!}
                @csrf
                                ...
                                <div class="tab-content tabcontent-border">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="name_bn" type="text" class="form-control @error('name_bn') is-invalid @enderror" name="name_bn" value="{{ $product->name_bn }}" required autocomplete="name_bn" autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="sub_name" type="text" class="form-control @error('sub_name') is-invalid @enderror" name="sub_name" value="{{ $product->sub_name }}" autocomplete="sub_name" autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="sub_name_bn" type="text" class="form-control @error('sub_name_bn') is-invalid @enderror" name="sub_name_bn" value="{{ $product->sub_name_bn }}" autocomplete="sub_name_bn" autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" min="1" value="{{ $product->quantity }}" required autocomplete="quantity" autofocus>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" min="1" value="{{ floatval($product->price) }}" required autocomplete="price" autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img width="150px" src="{{ 'data:image/' . $product->image_type . ';base64,' . $product->image }}" alt="{{ $product->name }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="multiSelection js-states form-control" name="unit_id">
                                                        ...
                                                        <option value="{{ $unit->id }}" @if($product->unit_id === $unit->id) selected @endif>{{ $unit->short_format }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="tab-pane p-20" id="description" role="tabpanel">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea_editor form-control @error('description') is-invalid @enderror" name="description" rows="15" placeholder="Enter text ...">{!! $product->description !!}</textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <input class="@error('discount_amount') is-invalid @enderror" id="manualDiscount" type="radio" name="discount" aria-label="radio for following text input" @if($product->discount_amount !== null) checked @endif>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group" id="DP">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <input class="@error('discount_percentage') is-invalid @enderror" id="manualPercentage" type="radio" name="discount" aria-label="radio for following text input" @if($product->discount_percentage !== null) checked @endif>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="salePrice" type="number" class="form-control @error('sale_price') is-invalid @enderror" min="1" name="sale_price" min="1" value="{{ floatval($product->sale_price) }}" required autocomplete="sale_price" readonly autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <input class="@error('special_image') is-invalid @enderror" id="specialOffer" name="special_offer" type="checkbox"  aria-label="Checkbox for following text input" @if(old('special_offer') || $product->special_offer == 'on') checked @endif>
                                                            </div>
                                                        </div>
                                                ...
                                                @if($product->special_image != null)
                                                <div class="form-group">
                                                    <label for="previous_image">Previous Special Image</label>
                                                    </br>
                                                    <img width="150px" src="{{ 'data:image/' . $product->special_image_type . ';base64,' . $product->special_image }}" alt="{{ $product->name }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach(json_decode($product->meta_tags) as $key => $tags)
                                                    ...
                                                    <input type="hidden" id="pre_tags" name="pre_meta_tags" value="{{ implode(',',json_decode($product->meta_tags)) }}">
                                                    @endif
                                                    <input id="meta_tags" type="text" class="form-control @error('hidden_meta_tags') is-invalid @enderror" name="meta_tags" value="" autocomplete="tags" autofocus>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea_editor form-control @error('meta_description') is-invalid @enderror" name="meta_description" rows="15" placeholder="Enter text ...">{!! $product->meta_description !!}</textarea>
...
$(document).ready(function() {
    ...
    if($("#manualDiscount").prop("checked") == true) {
        ...
        $('.discountA').append('<div class="form-group" id="discountAmount"><label for="discount">Discount Amount</label><input id="inputDiscountAmount" type="number" class="form-control" name="discount_amount" min="1" value="{{ $product->discount_amount }}" autocomplete="discount" autofocus><div class="checkPrice"><div></div>');
    ...
    if($("#manualPercentage").prop("checked") == true) {
        ...
        $('.discountP').append('<div class="form-group" id="discountPercentage"><label for="discount_percentage">Discount Percentage</label><input id="inputDiscountPercentage" type="number" class="form-control" name="discount_percentage" min="1" value="{{ $product->discount_percentage }}" autocomplete="discount_percentage" autofocus><div class="checkPrice"><div></div>');
