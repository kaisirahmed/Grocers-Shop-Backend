...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
            {!! Form::open([ 'method'=>'POST', 'route' => ['admin.cms.store'], 'files' => true , 'class' => 'custom-validation']) !!}
                @csrf
                <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="pageName" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                                <label for="slug">http://www.grocerbd.com/
                                                    <input id="permalink" name="slug" value="{{ old('slug') }}" type="text" autofocus="off" autocomplete="off" class="permalink">
                                                </label>
                                                @error('name')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea_editor form-control @error('content') is-invalid @enderror" name="content" rows="15" placeholder="Enter text ...">{{ old('content') }}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea_editor form-control @error('content_bn') is-invalid @enderror" name="content_bn" rows="15" placeholder="Enter text ...">{{ old('content_bn') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="meta_title_bn" type="text" class="form-control @error('meta_title_bn') is-invalid @enderror" name="meta_title_bn" value="{{ old('meta_title_bn') }}" autocomplete="meta_title_bn" autofocus>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="meta_tags" type="text" class="form-control @error('hidden_tags') is-invalid @enderror" name="meta_tags" value="" autocomplete="meta_tags" autofocus>
